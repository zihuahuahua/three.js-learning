...
export default {
  ...
  methods: {
    ...
    buildRoad() {
      ...
      let roadBorderOuterShape = utils.makeShape(
        roadBorderOuterCoords,
        roadBorderOuterHoleCoords
      );
      let roadBorderOuterGeometry = utils.makeExtrudeGeometry(
        roadBorderOuterShape,
        0.1
      );
      let roadBorderOuter = utils.makeMesh(
        "phong",
        roadBorderOuterGeometry,
        roadColor
      );
      ...
      let roadBorderInnnerGeometry = utils.makeExtrudeGeometry(
        roadBorderInnerShape,
        0.1
      );
      let roadBoaderInnder = utils.makeMesh(
        "phong",
        roadBorderInnnerGeometry,
        roadColor
      );
      ...
      roadLinesGeometry = new THREE.BufferGeometry().fromGeometry(
        roadLinesGeometry
      );
    ...
    buildbuilding() {
      ...
      function createHospital() {
        ...
        // for y-axis
        let frontRoofShelfCubeYPosition = [[0, 0], [1, 0], [0, 1], [1, 1]];
        ...
        frontRoofShelfGeometry = new THREE.BufferGeometry().fromGeometry(
          frontRoofShelfGeometry
        );
        let frontRoofShelf = utils.makeMesh(
          "phong",
          frontRoofShelfGeometry,
          0xffffff
        );
        ...
        let frontPlatVertical = utils.makeMesh(
          "phong",
          frontPlatVerticalGeometry,
          0x0792a5
        );
        ...
        let frontPlatVerticalWhiteGeometry = new THREE.BoxBufferGeometry(
          150,
          3,
          3
        );
        let frontPlatVerticalWhite = utils.makeMesh(
          "phong",
          frontPlatVerticalWhiteGeometry,
          0xffffff
        );
        ...
        let frontPlatPillar = utils.makeMesh(
          "lambert",
          frontPlatPillarGeometry,
          0xffffff
        );
        ...
        let frontBorderVerticleGeometry = new THREE.BoxBufferGeometry(
          4,
          106,
          4
        );
        let frontBorderVerticleMesh = utils.makeMesh(
          "phong",
          frontBorderVerticleGeometry,
          0xffffff
        );
        ...
        let frontRoofShape = utils.makeShape(
          frontRoofCoords,
          frontRoofHolePath
        );
        ...
        let backMiddleCoords = [[0, 0], [36, 0], [36, 70], [0, 70], [0, 0]];
        let backMiddleHolePath = [[2, 2], [34, 2], [34, 68], [2, 68], [2, 2]];
        let backMiddleShape = utils.makeShape(
          backMiddleCoords,
          backMiddleHolePath
        );
        let backMiddkeGeometry = utils.makeExtrudeGeometry(
          backMiddleShape,
          165
        );
        let backMiddle = utils.makeMesh(
          "lambert",
          backMiddkeGeometry,
          0xffffff
        );
        ...
        let backMiddleWindowMaterial = new THREE.MeshPhongMaterial({
          map: textures.window()
        });
        backMiddleWindowMaterial.map.repeat.set(2, 6);

        let backMiddleWindow = new THREE.Mesh(
          backMiddleWindowGeometry,
          backMiddleWindowMaterial
        );
      ...
      function createWindow() {
        ...
        let windowBorder = utils.makeMesh(
          "phong",
          windowBorderGeometry,
          0xffffff
        );
